    ...
    def __get_preview_image(self):
        ...
        if self.preview_augmentations.get():
            input_module = InputPipelineModule({
                ...
                'enable_random_noise': self.concept.image.enable_random_noise,
                'enable_fixed_noise': self.concept.image.enable_fixed_noise,
                'random_noise_max_strength': self.concept.image.random_noise_max_strength,
                'random_noise_min_strength': self.concept.image.random_noise_min_strength,
