...
class HiDreamBaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: HiDreamModel):
        ...
        add_embeddings_to_prompt_4 = MapData(in_name='prompt', out_name='prompt_4', map_fn=model.add_text_encoder_4_embeddings_to_prompt)
        ...
        tokenize_prompt_1 = Tokenize(in_name='prompt_1', tokens_out_name='tokens_1', mask_out_name='tokens_mask_1', tokenizer=model.tokenizer_1, max_token_length=128)
        tokenize_prompt_2 = Tokenize(in_name='prompt_2', tokens_out_name='tokens_2', mask_out_name='tokens_mask_2', tokenizer=model.tokenizer_2, max_token_length=128)
        tokenize_prompt_3 = Tokenize(in_name='prompt_3', tokens_out_name='tokens_3', mask_out_name='tokens_mask_3', tokenizer=model.tokenizer_3, max_token_length=128)
        tokenize_prompt_4 = Tokenize(in_name='prompt_4', tokens_out_name='tokens_4', mask_out_name='tokens_mask_4', tokenizer=model.tokenizer_4, max_token_length=128)
        ...
        if model.tokenizer_4:
            modules.append(add_embeddings_to_prompt_4)
            modules.append(tokenize_prompt_4)
    ...
    def _cache_modules(self, config: TrainConfig, model: HiDreamModel):
        ...
        sort_names = image_aggregate_names + image_split_names + [
            'prompt_1', 'tokens_1', 'tokens_mask_1', 'text_encoder_1_pooled_state',
            'prompt_2', 'tokens_2', 'tokens_mask_2', 'text_encoder_2_pooled_state',
            'prompt_3', 'tokens_3', 'tokens_mask_3', 'text_encoder_3_hidden_state',
            'prompt_4', 'tokens_4', 'tokens_mask_4', 'text_encoder_4_hidden_state',
            'concept'
        ]
        ...
        if not config.train_text_encoder_4_or_embedding():
            text_split_names.append('tokens_4')
            text_split_names.append('tokens_mask_4')
            text_split_names.append('text_encoder_4_hidden_state')
    ...
    def _output_modules(self, config: TrainConfig, model: HiDreamModel):
        output_names = [
            'image_path', 'latent_image',
            'prompt_1', 'prompt_2', 'prompt_3', 'prompt_4',
            'tokens_1', 'tokens_2', 'tokens_3', 'tokens_4',
            'tokens_mask_1', 'tokens_mask_2', 'tokens_mask_3', 'tokens_mask_4',
