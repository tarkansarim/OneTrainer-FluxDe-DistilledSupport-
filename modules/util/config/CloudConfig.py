...
class CloudConfig(BaseConfig):
    ...
    def default_values():
        ...
        data.append(("onetrainer_dir", "/workspace/OneTrainer-Plus", str, False))
        data.append(("install_cmd", "git clone https://github.com/tarkansarim/OneTrainer-Plus OneTrainer-Plus", str, False))
